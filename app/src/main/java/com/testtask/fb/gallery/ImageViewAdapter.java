...
public class ImageViewAdapter extends android.support.v4.view.PagerAdapter {
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        ...
        final View item_view = layoutInflater.inflate(R.layout.image_swipe_layout, container, false);
        imageView = (ZoomableImageView) item_view.findViewById(R.id.ivFaceBook);
